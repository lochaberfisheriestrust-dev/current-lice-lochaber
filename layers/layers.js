...
lyr_WildfishliceTarangerscore_3.set('fieldLabels', {'field_1': 'hidden field', 'Site': 'inline label - visible with data', 'Date': 'no label', 'fish_number': 'inline label - visible with data', 'Average Lice /g': 'no label', 'Taranger Total risk (%)': 'no label', 'x': 'hidden field', 'y': 'hidden field', });
