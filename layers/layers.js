...
var lyr_Tarangerrisk_3 = new ol.layer.Vector({
    ...
    <img src="styles/legend/Tarangerrisk_3_2.png" /> 50 %<br />\
    <img src="styles/legend/Tarangerrisk_3_3.png" /> 100 %<br />' });
...
lyr_Tarangerrisk_3.set('fieldAliases', {'field_1': 'field_1', 'Site': 'Site', 'Date': 'Date', 'fish_number': 'fish_number', 'Average Lice /g': 'Average Lice /g', 'Taranger Total risk (%)': 'Taranger Total risk (%)', 'x': 'x', 'y': 'y', });
...
lyr_Tarangerrisk_3.set('fieldImages', {'field_1': 'Range', 'Site': 'TextEdit', 'Date': 'DateTime', 'fish_number': 'Range', 'Average Lice /g': 'TextEdit', 'Taranger Total risk (%)': 'Range', 'x': 'Range', 'y': 'Range', });
...
lyr_Tarangerrisk_3.set('fieldLabels', {'field_1': 'hidden field', 'Site': 'hidden field', 'Date': 'inline label - always visible', 'fish_number': 'inline label - visible with data', 'Average Lice /g': 'inline label - visible with data', 'Taranger Total risk (%)': 'inline label - visible with data', 'x': 'hidden field', 'y': 'hidden field', });
