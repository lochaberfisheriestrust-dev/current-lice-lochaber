var size = 0;
var placement = 'point';
function categories_Wildfishsealiceriskcatergory_3(feature, value, size, resolution, labelText,
...
var style_Wildfishsealiceriskcatergory_3 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    ...
    var labelText = ""; 
    var value = feature.get("Taranger Total risk Score");
    ...
    var style = categories_Wildfishsealiceriskcatergory_3(feature, value, size, resolution, labelText,
