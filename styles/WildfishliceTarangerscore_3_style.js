var size = 0;
var placement = 'point';
function categories_WildfishliceTarangerscore_3(feature, value, size, resolution, labelText,
...
case '20':
                    return [ new ol.style.Style({
        image: new ol.style.Circle({radius: 10.0 + size,
            displacement: [0, 0], stroke: new ol.style.Stroke({color: 'rgba(35,35,35,1.0)', lineDash: null, lineCap: 'butt', lineJoin: 'miter', width: 0.0}), fill: new ol.style.Fill({color: 'rgba(255,252,0,1.0)'})}),
        text: createTextStyle(feature, resolution, labelText, labelFont,
                              labelFill, placement, bufferColor,
                              bufferWidth)
    })];
...
var style_WildfishliceTarangerscore_3 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    ...
    var labelText = ""; 
    var value = feature.get("Taranger Total risk (%)");
    ...
    var style = categories_WildfishliceTarangerscore_3(feature, value, size, resolution, labelText,
